...
export default function CForm({
  ...
  // TODO: We can improve the regex check with a better approach like in the
  // card component.
  ...
  const onCvvFocus = (event) => { onUpdateState('isCardFlipped', true); };

  const onCvvBlur = (event) => { onUpdateState('isCardFlipped', false); };

  // NOTE: Currently the cursor on the card number field gets reset if we remove
  // a number, the code bellow was used in class components, need to transform
  // this to work with functional components. getSnapshotBeforeUpdate() {
  ...
  // };
    ...
    autoComplete = "off"
    onChange = {onCardNumberChange} maxLength = "19"
