...
class Card extends Component {
  ...
  removeEmptySpaces = cardNumber => { return cardNumber.replace(/\s+/g, ''); };
  ...
  outlineElementStyle = element => element ? {
    ...
    transform:
        `translateX(${element.offsetLeft}px) translateY(${element.offsetTop}px)`
  }
                                           : null;
  ...
  render() {
    ...
    cardCvv = cardCvv.split('');
        ...
        className = {`card-item__focus ${
            currentFocusedElm ? `-active` : ``}`} style =
        {
          this.state.style
        } />
                    <div className="card-item__cover">
                        <img
                            ...
                            src={
                                staticFilesUrl +
                                `/card -
            background / $ { this.state.backgroundImgname } `
                            }
